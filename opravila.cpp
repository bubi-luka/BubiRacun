...
void opravila::on_btn_sprejmi_clicked() { // ne preverja polj
	...
	QSqlDatabase base = QSqlDatabase::addDatabase("QSQLITE", "vnos_opravila");
	base.setDatabaseName(dbase_path);
	base.database();
	base.open();
	if(base.isOpen() != true){
...
void opravila::on_txt_skupina_currentIndexChanged() {
	...
	if ( ui->txt_skupina->currentText() != "" ) {
		...
		QSqlDatabase base = QSqlDatabase::addDatabase("QSQLITE", "napolni_storitve");
		base.setDatabaseName(dbase_path);
		base.database();
		base.open();
		if(base.isOpen() != true){
...
void opravila::on_txt_storitev_currentIndexChanged() {
	...
	if ( ui->txt_storitev->currentText() != "" ) {
		...
		QSqlDatabase base = QSqlDatabase::addDatabase("QSQLITE", "napolni_polja_storitve");
		base.setDatabaseName(dbase_path);
		base.database();
		base.open();
		if(base.isOpen() != true){
