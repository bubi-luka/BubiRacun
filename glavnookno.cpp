...
void GlavnoOkno::on_actionDobropisi_triggered() {

	wid_racuni *widrac = new wid_racuni;
	ui->scrollArea->setWidget(widrac);
	ui->lbl_pozicija->setText("Nahajate se na tabeli Dobropisi!");
	setWindowTitle(windowTitle().left(windowTitle().indexOf(" - ", 0)) + " - Dobropisi");
