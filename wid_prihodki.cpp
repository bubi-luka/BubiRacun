...
void wid_prihodki::napolni_letni_tabela() {
    ...
    if ( ui->tbl_storitve_3->selectedItems().count() > 0 ) {
        izbranec = ui->tbl_storitve_3->selectedItems().takeAt(0)->row();
    }

    razvrsti = ui->tbl_storitve_3->horizontalHeader()->sortIndicatorSection();
    ...
    ui->tbl_storitve_3->selectRow(izbranec);
    ui->tbl_storitve_3->sortByColumn(razvrsti, Qt::AscendingOrder);
...
void wid_prihodki::napolni_skupni_tabela() {
    ...
    if ( ui->tbl_storitve_4->selectedItems().count() > 0 ) {
        izbranec = ui->tbl_storitve_4->selectedItems().takeAt(0)->row();
    }

    razvrsti = ui->tbl_storitve_4->horizontalHeader()->sortIndicatorSection();
    ...
    ui->tbl_storitve_4->selectRow(izbranec);
    ui->tbl_storitve_4->sortByColumn(razvrsti, Qt::AscendingOrder);
